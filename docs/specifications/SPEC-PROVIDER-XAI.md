...
- SPEC-PROVIDER-KIMI / REQ-PROVIDER-KIMI: implemented analog ([`plugins/custom/provider-oauth.lua`](../../plugins/custom/provider-oauth.lua), [`plugins/custom/oauth_jwt.lua`](../../plugins/custom/oauth_jwt.lua), [`plugins/custom/oauth_store.lua`](../../plugins/custom/oauth_store.lua), [`plugins/custom/oauth_device.lua`](../../plugins/custom/oauth_device.lua))
