...
| FR-9.x score family | Implemented | gateway-model-experience.json p40/p41 (Overall = sqrt(PAI × Reliability), fixed goalposts 50/100/5/5, geometric aggregation, ≥30-request gate, friction/speed excluded); live: 12 models ranked, kimi-k3 88.7 / glm-5.3 81.9 / glm-5.2 0.0 |
